    ...
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        {memberships.map(({ team, role }) => {
            const settings = team.featureSettings ?? { commentsEnabled: false, attachmentsEnabled: false, memberTaskViewEnabled: false, finishedTaskViewEnabled: false, attachmentLimitMb: 5 };
          return (
